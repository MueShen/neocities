...
if(window.location.href.match(/\/admin\/players\/[0-9]+/)){
  const arrayOfComments=[
      "Со слов игрока N аккаунт N принадлежит ему.",
      "Со слов игрока N аккаунт N принадлежит N .",
      "Со слов игрока N аккаунт N не знаком.",
      "Аккаунт заблокирован по пункту правил 5.5. Основной аккаунт N",
      "Аккаунты NNN заблокированы согласно пункту правил 5.5",
      "Основной аккаунт игрока. Дублирующий аккаунт N заблокирован.",
      "Дублирующий аккаунт заблокирован. Основной аккаунт игрока N .",
      "Принадлежность была подтверждена отправкой письма с кодом на почту.",
      "Со слов игрока аккаунт N принадлежит ему. К почте нет доступа, поэтому не направил код. При повторном обращении предложить залогиниться и загрузить документы.",
      ...
      "Данные в профиле были изменены в соответствии с паспортными после загрузки документов (и звонка) по согласованию с N.",
      "Аккаунт игрока заблокирован в соответствии с пунктом правил 4.4.",
      "Аккаунт игрока заблокирован по пункту правил 4.4. до предоставления документов о местонахождении. Согласовано с N.",
      "Номер телефона запрещённой страны проработан в чате. Игроку разрешено играть на сайте. Согласовано с N.",
      ...
      "Карта N является виртуальной.",
      "На карту N был установлен запрет. Причина: ",
      "На карту N был установлен запрет по согласованию с N. Причина: ",
      "N был выдан в качестве бонуса за регистрацию."
  ];
